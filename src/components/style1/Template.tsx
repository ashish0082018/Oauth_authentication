...
function Template({name, message,selectedProfiles,imagepreview}:templatedata) {
  ...
  return (
    <div className="w-full md:w-full mt-10 bg-zinc-100 rounded-xl overflow-hidden shadow-xl shadow-purple-800">
      <div className="min-h-1/2  px-10 py-10 border border-zinc-500 shadow-xl rounded-md flex flex-col gap-5">
...
>
        ...
        <div className="text-center overflow-hidden">
          <h1 className="text-3xl tracking-tighter font-bold text-zinc-700 min-h-10 max-w-full break-words whitespace-normal">
            {name}
          </h1>
          <h6 className="text-zinc-500  min-h-7 h-full break-words whitespace-normal">
            {message}
          </h6>
        </div>
   ...
   selectedProfiles.length<1 ? <>
     ...
     </>: <>  {selectedProfiles.map((elem:selectProfile[0],key)=>{
    return (
        <>
     <div className=" rounded-full w-12 h-12 flex justify-center items-center overflow-hidden shadow-lg ">
